...
Bootstrapper::Bootstrapper(
    ...
    : loge(_loge), logn(_logn), logNh(_logNh), L(_L), final_scale(_final_scale), boundary_K(_boundary_K), sin_cos_deg(_sin_cos_deg),
      scale_factor(_scale_factor), inverse_deg(_inverse_deg), context(_context), keygen(_keygen), encoder(_encoder), encryptor(_encryptor),
      decryptor(_decryptor), evaluator(_evaluator), relin_keys(_relin_keys), gal_keys(_gal_keys)
{
    n = 1 << logn;
    Nh = 1 << logNh;
    mod_reducer =
...
void Bootstrapper::sfl_3(Ciphertext &rtncipher, Ciphertext &cipher)
{ // not yet
...
void Bootstrapper::sfl_half_3(Ciphertext &rtncipher, Ciphertext &cipher)
{ // not yet
    int div_part3 = floor(logn / 3.0);
    int div_part2 = floor((logn - div_part3) / 2.0);
    int div_part1 = logn - div_part3 - div_part2;
...
void Bootstrapper::sflinv_3(Ciphertext &rtncipher, Ciphertext &cipher)
{ // not yet
    int div_part1 = floor(logn / 3.0);
    int div_part2 = floor((logn - div_part1) / 2.0);
    int div_part3 = logn - div_part1 - div_part2;
